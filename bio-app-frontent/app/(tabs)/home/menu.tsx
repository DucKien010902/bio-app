    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.menuSection}>
          <MenuItem
            icon={<AntDesign name="home" size={20} color="#1890ff" />}
            label="Cơ sở y tế"
            onPress={() => router.push('/(tabs)/home/clinics')}
          />
          <MenuItem
            icon={<AntDesign name="appstore-o" size={20} color="#1890ff" />}
            label="Dịch vụ y tế"
            onPress={() => router.push('/(tabs)/home/service')}
          />
          <MenuItem
          ...
          <MenuItem
            icon={
              <AntDesign name="questioncircleo" size={20} color="#1890ff" />
            }
            label="Hướng dẫn"
          />
        </View>
        ...
        <View style={styles.menuSection}>
          ...
          />
          <MenuItem
            icon={<MaterialIcons name="phone" size={20} color="#ff4d4f" />}
            label="1900-2115"
          />
          <MenuItem
            icon={<MaterialIcons name="email" size={20} color="#d93025" />}
            label="Email: cskh@gentech.vn"
          />
        </View>
        ...
        <View style={styles.promo}>
          <Image
            source={{
              uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTh-5fWVITFdnwFqqjLfK0KZ0l2vUsqDV1HQQ&s',
            }}
